...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
                <select name="grade" >
                    <#if module.grade==0> <option value="0" selected="selected" >一级菜单</option></#if>
                    <#if module.grade==1><option value="1" selected="selected">二级菜单</option></#if>
                    <#if module.grade==2><option value="2" selected="selected">三级菜单</option></#if>
                </select>
        </div>
    </div>
